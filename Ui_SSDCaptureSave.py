...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_ReadTest.setGeometry(QtCore.QRect(630, 10, 91, 23))
        self.pushButton_ReadTest.setObjectName("pushButton_ReadTest")
        self.lineEdit_Times = QtWidgets.QLineEdit(self.tab_Files)
        self.lineEdit_Times.setGeometry(QtCore.QRect(820, 10, 51, 20))
        self.lineEdit_Times.setObjectName("lineEdit_Times")
        self.label = QtWidgets.QLabel(self.tab_Files)
        self.label.setGeometry(QtCore.QRect(740, 10, 71, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Read Times:"))
